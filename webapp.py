  ...
  <body>
    <div class="wrap">
      <div class="card">
        ...
        <h1>Forelka Authentication</h1>
        <p>Аутентификация сессии <code>forelka-&lt;id&gt;.session</code> для вашего юзербота.</p>
...
if __name__ == "__main__":
    ...
    app = create_app()
    # threaded=False чтобы Pyrogram Client не прыгал между потоками
